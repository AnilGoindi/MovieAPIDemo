    ...
    public class MovieController : ControllerBase
    {
        ...
        public IActionResult GetMovieById(int id)
        {
            ...
            try
            {
                ...
                var movieData = _mapper.Map<MovieListViewModel>(movie);
        ...
        public IActionResult Put(CreateMovieViewModel model)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    {
                        movieDetails.Actors.Add(actor);  // Add these
                    }
        ...
        public IActionResult Delete(int id)
        {
            ...
            try
            {
                ...
                response.Status = true;
                response.Message = "Deleted Movie Record successfully.";
            ...
            catch (Exception ex)
            {
                // TODO: do logging exceptions
                response.Status = false;
                response.Message = "Something went wrong while deleting Movie Record";
        ...
        public async Task<IActionResult> UploadMoviePoster(IFormFile imageFile) 
        {
            try
            {
                ...
                string newPath = @"D:\AnilDev\React\to-delete";
